...
class GameState(object):
    ...
    def getNearestFoodPosition(self):
        """
        Returns the nearest food position
        """
        outputDistance = None
...
def readCommand( argv ):
    ...
    if options.quietGraphics:
        ...
        args['display'] = graphicsDisplay.FirstPersonPacmanGraphics(options.zoom,  options.showGhosts, frameTime = options.frameTime)
...
def loadAgent(pacman, nographics):
    ...
    if nographics and pacman == 'BustersKeyboardAgent':
    ...
    for moduleDir in pythonPathDirs:
        ...
        for modulename in moduleNames:
            ...
            try:
                ...
                print("importado módulo {}".format(modulename))
            except ImportError:
                continue
